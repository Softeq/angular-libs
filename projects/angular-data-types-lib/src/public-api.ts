...
/*
 * Public API Surface of angular-data-types-lib
 */

export { DATA_TYPE_DEFAULT_VALIDATE_OPTION, DataTypeDirective, DataTypeValidateOption } from './lib/directives/data-type.directive';
